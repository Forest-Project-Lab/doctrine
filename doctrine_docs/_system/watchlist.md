...
第1項: ADR-004（編集前の状態を全文で復元する）。第2項・第3項: ADR-018（辞書駆動の覆い）・ADR-005（辞書の単一符号化）。第4項: SPEC-007（助言のみ）。第5項: ADR-024。第6項: SPEC-011 の adr_not_landed 検査。横断: DECIDED-001（横断の確定方針）。各項の実コードの位置は、本文に示したIDのとおり。
