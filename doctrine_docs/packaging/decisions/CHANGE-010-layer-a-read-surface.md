...
2026-08-13 追補: リリース 0.12.0 を実施した（tag `v0.12.0` = `62f33ad8256270492fdb703927d56e7e0b6b383b`）。
完了報告を issue #294・#212 へ投稿し、外部の消費者（doctrine-lens）の pin 候補として tag と
SHA（コミットを一意に指す指紋）を提示した。pin の更新は lens 側の仕事のまま（NONGOAL-001 第10項）。
