...
- 32 検査の重大度は固定とする（ICD-005 の表のとおり。`AUDIT_CHECKS` の名前は 34 個で、逆孤児の二種と未登録/影がそれぞれ一つの検査を二つの名前で持つ）。`top_findings` は error を優先し、上限 20 件とする。
...
- sha256:105a7b5ee53e5c87ce0efdb809d98c59c412f6496c95fdc441217963f693aed9
