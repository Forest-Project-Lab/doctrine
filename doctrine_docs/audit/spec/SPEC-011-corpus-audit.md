...
- 28 検査の重大度は固定とする（ICD-005 の表のとおり。`AUDIT_CHECKS` の名前は 30 個で、逆孤児の二種と未登録/影がそれぞれ一つの検査を二つの名前で持つ）。`top_findings` は error を優先し、上限 20 件とする。
...
- sha256:72178c7bac66d5fc439c583e3e4877592a655c665d9ecba07524ba800135cb35
